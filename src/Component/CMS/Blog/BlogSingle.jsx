        ...
        <div className="col-lg-8 entries">
          ...
          <div className="blog-comments" data-aos="fade-up">
            ...
            <div id="comment-1" className="comment clearfix">
              ...
              <h5><a href>Georgia Reader</a> <a href="#" className="reply"><i className="icofont-reply" /> Reply</a></h5>
            ...
            <div id="comment-2" className="comment clearfix">
              ...
              <h5><a href>Aron Alvarado</a> <a href="#" className="reply"><i className="icofont-reply" /> Reply</a></h5>
              <time dateTime="2020-01-01">01 Jan, 2020</time>
              <p>
              ...
              <div id="comment-reply-1" className="comment comment-reply clearfix">
                ...
                <h5><a href>Lynda Small</a> <a href="#" className="reply"><i className="icofont-reply" /> Reply</a></h5>
                <time dateTime="2020-01-01">01 Jan, 2020</time>
                <p>
                ...
                <div id="comment-reply-2" className="comment comment-reply clearfix">
                  ...
                  <h5><a href>Sianna Ramsay</a> <a href="#" className="reply"><i className="icofont-reply" /> Reply</a></h5>
                  <time dateTime="2020-01-01">01 Jan, 2020</time>
                  <p>
            ...
            <div id="comment-3" className="comment clearfix">
              ...
              <h5><a href>Nolan Davidson</a> <a href="#" className="reply"><i className="icofont-reply" /> Reply</a></h5>
              <time dateTime="2020-01-01">01 Jan, 2020</time>
              <p>
            ...
            <div id="comment-4" className="comment clearfix">
              ...
              <h5><a href>Kay Duggan</a> <a href="#" className="reply"><i className="icofont-reply" /> Reply</a></h5>
              <time dateTime="2020-01-01">01 Jan, 2020</time>
              <p>
