...
const Home = () => {
  ...
  if (loading) {
    return (
      <>
        {/* <div class="spinner-border text-primary" style={{height:"800px"}} role="status"> */}
          ...
          >
            <div className="carousel-inner" role="listbox">
              ...
              >
                <div className="carousel-container">
                  <div className="carousel-content animate__animated animate__fadeInUp">
                    <h2>
                      Welcome to <span>Kolkata Tourist</span>
                    </h2>
                    <p>
                      Kolkata is blessed with many sightseeing places that offer
                      a unique experience to every visitor. The city has many
                      interesting places to keep its visitors pleasantly
                      engaged. From refreshing gardens, serene lakes, historical
                      buildings, museums, libraries, sports stadiums to ancient
                      temples and churches, there are umpteen number of places
                      to visit in Kolkata
                    </p>
                    {/*read more  */}
              ...
              {/* <div
                ...
                style={{ backgroundImage: "url(assets/img/slide/slide-2.png)" }}
              >
                <div className="carousel-container">
                  <div className="carousel-content animate__animated animate__fadeInUp">
